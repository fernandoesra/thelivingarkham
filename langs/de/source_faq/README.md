# FAQ chapter 1 source PDF — Deutsch
...
|---|---|
| v2.5 (2026-02-01) | `arkham-horror-lcg-841333136918-faq-v2.5-kapitel-1.pdf` |
...
`data/faq_de.json`, which is committed. You need the PDF when you run:
