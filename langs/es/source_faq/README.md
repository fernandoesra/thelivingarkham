# FAQ chapter 1 source PDF — Español
...
|---|---|
| v2.5 (2026-02-01) | `ahc_faq_v25_february_2026-web_SPANISH.pdf` |
...
`data/faq_es.json`, which is committed. You need the PDF when you run:
