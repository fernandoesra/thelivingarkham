# FAQ chapter 1 source PDF — English
...
|---|---|
| v2.5 (2026-02-01) | `ahc_faq_v25_february_2026-web_ENGLISH.pdf` |
...
`data/faq_en.json`, which is committed. You need the PDF when you run:
